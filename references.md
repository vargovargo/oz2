...
**FFIEC Census Flat Files.** https://www.ffiec.gov/data/census/flat-files — Published annually by the Federal Financial Institutions Examination Council. Used by bank examiners to determine CRA tract income designations: Low (L), Moderate (M), Middle, Upper (U), plus the distressed/underserved flag for non-metro middle-income tracts. A tract is CRA LMI-eligible if its median family income is below 80% of the area median (MSA/MD for metropolitan tracts; statewide non-metro for rural). This site uses the 2025 exam year file (CensusFlatFile2025), released July 2025. FFIEC census data landing page: https://www.ffiec.gov/data/census. last_checked: 2026-07-10

**FFIEC Geocoding/Mapping System (tract lookup).** https://www.ffiec.gov/geocode/ — FFIEC-maintained tool for looking up a specific address or census tract's CRA income level, MSA/MD classification, and demographic data. The annual distressed/underserved list is published at https://www.ffiec.gov/data/cra/distressed. Useful for verifying whether a specific OZ-eligible tract carries CRA LMI or D/U status. (An earlier version of this entry cited ffiec.cfpb.gov/tools/tract-search, which does not exist — the CFPB-hosted FFIEC platform carries HMDA filing tools only.) last_checked: 2026-07-10

**OCC — Opportunity Zones fact sheet for banks.** https://www.occ.gov/publications-and-resources/publications/community-affairs/community-developments-fact-sheets/cd-fact-sheet-opportunity-zones.html — OCC Community Developments fact sheet explaining how banks subject to OCC supervision can document OZ-related activities for CRA credit. Notes that CRA-qualifying community development activities in OZ tracts include affordable housing, community services, economic development loans, and equity investments that benefit LMI persons or geographies. last_checked: 2026-07-10

**Federal Reserve — Community Reinvestment Act.** https://www.federalreserve.gov/consumerscommunities/cra_about.htm — Overview of CRA requirements for state member banks. The 2023 CRA Final Rule (jointly issued by the Fed, OCC, and FDIC) would have updated community development investment test criteria, but it never took effect: a federal court enjoined it in March 2024, and the agencies proposed rescinding it and reinstating the 1995-era regulations in July 2025 (comment period closed August 18, 2025). Examiners continue to apply the pre-2023 framework; LMI tract income designations remain aligned with the FFIEC census flat file methodology. last_checked: 2026-07-10
